    ...
    try {
      if (response == null) {
        return onFailureCallBackWithMessage(
            NetworkResponseErrorType.responseEmpty, 'No response found. Please try again');
      }
      ...
      return onFailureCallBackWithMessage(
          NetworkResponseErrorType.didNotSucceed, 'Error occurred processing request. Try again!');
      ...
      return onFailureCallBackWithMessage(
          NetworkResponseErrorType.exception, 'Network error. Please check that you have internet connection!');
    }
